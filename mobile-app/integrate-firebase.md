...
- This app also uses **Firebase Realtime Database** and **Firebase Storage**, which aren't part of the common guide above — see [Firebase Database](firebase-database.md) and [Firebase Storage](firebase-storage.md).
