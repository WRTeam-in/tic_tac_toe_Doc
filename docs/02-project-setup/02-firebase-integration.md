...
1. Go to the [Firebase Console](https://console.firebase.google.com/) and click **Add project**.
   ...
   ![Create Firebase project](../../images/app/createFirebase1.png)
   ![Create Firebase project step 2](../../images/app/createFirebase2.jpg)
   ![Create Firebase project step 3](../../images/app/createFirebase3.jpg)
   ![Create Firebase project step 4](../../images/app/createFirebase4.jpg)
...
1. **Add an Android app** to your Firebase project (Project settings → Your apps → Add app → Android), enter your package name, and register.
   ...
   ![Add Android app](../../images/app/addAndroid.jpg)

2. Add your SHA-1 key — see [this guide](https://developers.google.com/android/guides/client-auth) on how to get it.

   ![Get SHA-1 key](../../images/app/addAndroid2.jpg)
   ![Add SHA-1 to Firebase](../../images/app/addAndroid3.jpg)
   ![Confirm Android app added](../../images/app/addAndroid4.jpg)

3. Download `google-services.json` and place it in `android/app/`.

4. **Add an iOS app** to your Firebase project (Project settings → Your apps → Add app → iOS).

   ![Add iOS app](../../images/app/addIos.jpg)
...
5. Get your bundle ID from `[your-flutter-project-dir]/ios/Runner.xcodeproj/project.pbxproj` (search for `PRODUCT_BUNDLE_IDENTIFIER`).
   ...
   ![Find bundle ID](../../images/app/addIos3.jpg)
   ![Add iOS app step 2](../../images/app/addIos2.jpg)
   ![Add iOS app step 3](../../images/app/addIos4.jpg)
   ![Add iOS app step 4](../../images/app/addIos5.jpg)
   ![Add iOS app step 5](../../images/app/addIos6.jpg)
...
With either method, your Android and iOS apps are now connected to your Firebase project. Continue to [Firebase Authentication](03-firebase-auth.md).
